module.exports.config = {
  ...
  expandedHelp:
    'Attempts to identify files using trid. Either use a url to a file, an attachment, or call for it to lookup the first file it finds in the channel.',
  usage: [
    'Get file from url and try to identify it',
    'trid https://some.file/meme.aaa',
    'Get file from attachment and try to identify it',
    'trid <Attachment in message>',
    'Grab last attachment in chat and try to identify it',
    'trid',
  ],
}
