...
module.exports.events.message = (bot, message) => {
  ...
  if (!msg)
    return message.channel.send('I need a message ID to work with.')

  bot.channels.get(logs[message.guild.id]).fetchMessage(msg)
  .then(m => {
    ...
    m.edit({embed})
     ...
     .catch(e => message.channel.send(`I got an error while trying to edit:\n${e}`))
  })
  .catch(e => message.channel.send('Could not find that message in the log channel.'))
}
